...
const I18N = {
  zh: {
    ...
    'hero.sub': '我平时要同时开很多个 md 文件，可 Typora 每打开一个文件，就多出一个 Typora，任务栏很快排满了它。于是自己做了 HorseMD：打字即渲染没变，但所有文件都开在同一个窗口里，有<strong>标签页</strong>，有<strong>文件树</strong>。',
  ...
  en: {
    ...
    'hero.sub': 'I keep a lot of .md files open at once, but every file you open spawns another whole Typora. So I built HorseMD: the same type-and-it-renders editing, with <strong>tabs</strong> and a <strong>file tree</strong>, all in one window.',
